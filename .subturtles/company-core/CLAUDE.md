...
- [ ] Create `src/components/company/CompanyPage.js` — route `/company/:slug`, loads company by slug, displays: cover photo, logo, name, industry, size, follower count, admin actions dropdown. Use MUI Card, Avatar, Typography. Match the green theme (#2e7d32 / theme.palette.primary). <- current
