...
validate_loop_type_prereqs() {
  ...
  if [[ "$loop_type" == "yolo-codex-spark" ]] && is_loop_type_supported_here "yolo-codex"; then
    suggestion="Try --type yolo-codex until the requested Codex runtime is available."
  elif [[ "$loop_type" == "yolo-codex" ]] && is_loop_type_supported_here "yolo-codex-spark"; then
    suggestion="Try --type yolo-codex-spark until the requested Codex runtime is available."
  fi
