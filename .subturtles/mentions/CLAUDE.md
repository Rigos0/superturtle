## Current Task
Render @mentions as styled links in post text.
...
- [ ] Render @mentions as styled links in post text — in Post.js, regex-replace @username with clickable link to `/:username` <- current
